...
def generate_data(args, dataset, key):
    ...
    # elif dataset == "hc3":
    #     # Load HC3 locally
    #     data = custom_datasets.load_dataset("../dataset/processed_data", split='train', cache_dir=args.cache_dir)[key]
    elif dataset == "fluoroscopy":
        data = datasets.load_dataset("json", data_files="../dataset/processed_data/test_data/xsum/xsum_claude3.json", split="train", cache_dir=args.cache_dir)
        data = data[key]
    else:
    ...
    if dataset in ['writing', 'squad', 'xsum', 'hc3']:
...
if __name__ == '__main__':
    ...
    dataset_keys = {'xsum': 'document', 'squad': 'context', 'writing': 'document', 'fluoroscopy': 'text'}
